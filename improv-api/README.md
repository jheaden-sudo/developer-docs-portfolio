...
This API serves a small collection of improv game ideas as JSON. It is a simple Express server that exposes a single endpoint for retrieving the available games.
